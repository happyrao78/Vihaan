...
const HealthRegister = ({ handleChange, nextStep, formData, handleSubmit }) => {
  const variants = {
    hidden: { opacity: 0 },
    enter: { opacity: 1 },
    exit: { opacity: 0 },
      ...
      <div className="flex items-start justify-start h-full w-full">
        <div className="flex items-start justify-start flex-col gap-6 w-full">
          ...
          <button
            ...
            className="button mb-24 md:mb-12 button-white w-full relative bg-[#FF5500] text-white inline-flex h-[3rem] items-center justify-center gap-[1rem] rounded-lg border-opacity-[1] border-[rgb(242,246,250,0.1)] px-[2.5rem] text-center text-xl font-[500] transition-all tracking-wide"
          >
            Next
          </button>
        </div>
