...
const SevenQuestionnare = ({
  ...
  return (
    ...
    >
        ...
        <form className="mx-auto grid min-w-0 max-w-screen-2xl grid-cols-1 gap-6 xs:px-2 lg:px-4 sm:grid-cols-2">
            ...
            >
              <div className="flex h-full flex-col justify-center gap-2">
                <div className="flex items-center justify-between w-full">
                  <aside className="code p-1 text-2xl">Morning Owl</aside>
                  <input
                    type="radio"
                    id="1"
                    name="score"
                ...
                <img src={hSeven} alt="rash" className="mx-auto h-[15rem]" />
          ...
          <div className="noise-panel flex flex-col min-w-0 relative text-gray-200 md:hover:scale-105 transition ease-in-out duration-500">
            ...
            >
              <div className="flex h-full flex-col justify-center gap-2">
                <div className="flex items-center justify-between w-full">
                  <aside className="code p-1 text-2xl">Night Owl</aside>
                  <input
                    type="radio"
                    id="2"
                    name="score"
      ...
      <div className="flex items-center justify-center flex-row max-w-4xl mb-32 md:mb-12 w-[90%] p-2 lg:p-6 gap-6">
        <button
          onClick={prevStep}
...
export default SevenQuestionnare;
