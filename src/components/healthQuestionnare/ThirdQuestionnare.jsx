        ...
        <form className="mx-auto grid min-w-0 max-w-screen-2xl grid-cols-1 gap-6 xs:px-2 lg:px-4 sm:grid-cols-2">
            ...
            >
              <div className="flex h-full flex-col justify-center gap-2">
                <div className="flex items-center justify-between w-full">
                  <aside className="code p-1 text-2xl">Netflix</aside>
                  <input
                    type="radio"
                    id="1"
                    name="score"
                ...
                <img src={hThird} alt="rash" className="mx-auto h-[15rem]" />
          ...
          <div className="noise-panel flex flex-col min-w-0 relative text-gray-200 md:hover:scale-105 transition ease-in-out duration-500">
            ...
            >
              <div className="flex h-full flex-col justify-center gap-2">
                <div className="flex items-center justify-between w-full">
                  <aside className="code p-1 text-2xl">IMAX</aside>
                  <input
                    type="radio"
                    id="2"
                    name="score"
...
export default ThirdQuestionnare;
